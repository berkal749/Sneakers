  ...
  return (
    <div className="w-5/10  h-6/12 flex flex-col justify-between pr-11 pl-10 ">
      ...
      <div>
        ...
        <div className="mt-0 flex justify-center w-1/10  text-gray-500  ml-1.5 line-through">250.00$</div>
      </div>
      ...
      <div className="flex justify-between w-113 h-12">
        ...
        <button className=" w-md ml-3 rounded-md bg-orange-500" >add to cart</button>
      </div>
    </div>
  );
}
