function Footer() {
  return (
    <div className="bg-[hsl(220,16%,35%)] text-white mt-2.5 h-4/10  flex flex-col justify-center items-center">
      ...
      <div className="w-2/5 shadow-2xs h-1/2 shadow-gray-300">
        ...
        <div className="flex gap-7 text-3xl h-1/2 ">
          <img  src="Social-media-icons/facebook.svg" alt="" />
          <img src="Social-media-icons/pen-off.svg" alt="" />
          <img  src="Social-media-icons/instagram.svg" alt="" />
          <img  src="Social-media-icons/linkedin.svg" alt="" />
        </div>
      </div>
</div>
